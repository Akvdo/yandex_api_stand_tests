...
def negative_assert_symbol(first_name):
    ...
    # Строки, которая должна быть в ответе
...
# Параметр fisrtName: Разрешены русские символы
...
# Параметр fisrtName: Запрещены спецсимволы
...
# Параметр fisrtName: Параметр не передан в запросе
def test_create_user_has_no_first_name_get_error_response():
    # копирование словаря с телом запроса из файла data, чтобы не потерять данные в исходном словаре
...
# Параметр fisrtName: Передано пустое значение параметра
